...
APP.aeropuertos = (function () {
  ...
  var CATALOGO = {
    ...
    CCP: { ciudad: 'Concepcion',     pais: 'Chile' },
    ...
    LIM: { ciudad: 'Lima',           pais: 'Peru' },
    EZE: { ciudad: 'Buenos Aires',   pais: 'Argentina' },
    MVD: { ciudad: 'Montevideo',     pais: 'Uruguay' },
    GRU: { ciudad: 'Sao Paulo',      pais: 'Brasil' },
    BOG: { ciudad: 'Bogota',         pais: 'Colombia' },
    ASU: { ciudad: 'Asuncion',       pais: 'Paraguay' },
    MAD: { ciudad: 'Madrid',         pais: 'Espana' },
